...
#define lcm_eventlog_create LCM_NAMESPACED(eventlog_create)
#define lcm_eventlog_read_next_event LCM_NAMESPACED(eventlog_read_next_event)
#define lcm_eventlog_free_event LCM_NAMESPACED(eventlog_free_event)
#define lcm_eventlog_seek_to_timestamp LCM_NAMESPACED(eventlog_seek_to_timestamp)
#define lcm_eventlog_write_event LCM_NAMESPACED(eventlog_write_event)
#define lcm_eventlog_destroy LCM_NAMESPACED(eventlog_destroy)
